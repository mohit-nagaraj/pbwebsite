  ...
  const currentLeads: Lead[] = [
    {
      ...
      imageUrl:
        "https://media.licdn.com/dms/image/v2/D5603AQFeShMi1sbKLg/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1718481763562?e=1729123200&v=beta&t=60HO7YQ53F44tUfCHikuDNYHZPojS2SJD0msO1Sm3eY",
    },
    {
      id: "1",
      name: "Saalim Quadri",
      ...
      imageUrl:
        "https://ik.imagekit.io/qx5kklh3ls/WhatsApp%20Image%202023-10-29%20at%2011.12.20%20AM.jpeg?updatedAt=1698558279266",
    },
    {
      id: "3",
      name: "Pratyush Singh",
      ...
      imageUrl:
        "https://github-production-user-asset-6210df.s3.amazonaws.com/90026952/279694915-c7693363-6623-4bd2-9503-ee092b0e3593.jpeg",
    },
  ];
  ...
  const alumniLeads: Lead[] = [
    {
      ...
      additionalInfo: "",
      imageUrl:
        "https://ik.imagekit.io/qx5kklh3ls/index.jpeg?updatedAt=1678781533632",
    },
    {
      id: "4",
    ...
    },
    {
      ...
      additionalInfo: "",
      imageUrl:
        "https://avatars.githubusercontent.com/u/83706503?s=400&u=2d00114433bc28b8e28252e41bbc919229b9a7f4&v=4",
    },
  ];
...
const LeadSection: React.FC<LeadSectionProps> = ({ title, leads }) => (
  <div
    style={{
      padding: "1rem",
      marginTop: title === "Alumni Leads" ? "2rem" : "2rem",
    }}
  >
    <h3
      style={{
