            ...
            <div className=" h-auto w-auto lg:flex p-5 transition-transform duration-1000 ease-in-out transform hover:scale-105 hover:shadow-2xl">
              ...
              <div className="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-grey rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                <div className="mb-8">
                  ...
                  <p className="text-green-600 text-base">{data.description}</p>
                </div>
              </div>
            </div>
          ))}
...
const data = [
  {
    ...
    name: "Mohit Agarwal",
    description:
      "Mohit is currently an SDE2 at Glance (InMobi). Before this, he had stints at Ola and Amazon. Known for his straight, no nonsense attitude, Mohit laid the foundation for Competitive Programming culture in Point Blank. In his time as a student, Mohit won several contests such as the Nokia Collegiate Code Rally and qualified to the Regionals of the ACM-ICPC.",
  },
  {
    url: "/images/founder2.png",
    name: "Soumya Pattanayak",
    description:
      "Widely regarded as one of DSCE’s strongest competitive programmers, Soumya was previously an SDE at Amazon and had a stint in Verse Innovation before moving on to do his own thing. Soumya’s skills in solving problems are only exceeded by his ability to grok new languages and build interesting projects. He’s also an ACM-ICPC regionalist.",
  },
  {
    url: "/images/founder3.jpg",
    name: "Ashutosh Pandey",
    description:
      "Ashutosh is currently a Compiler Engineer at AMD. As a student he did Google Summer of Code with Arduino, was a Linux Foundation mentee with ELISA, and won several Hackathons including the Smart India Hackathon in 2019. He built up the Open Source and Hackathon culture in Point Blank, with numerous students going on to do prestigious programmes.",
  },
];
